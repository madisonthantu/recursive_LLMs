...
def main():
    ...
    if data_args.DEBUG == False:
        ...
        assert(f"gen{model_args.gen_num}" in training_args.output_dir.lower()), "Must include <generation_number> in output directory path"
    if model_args.gen_num not in ['baseline', '0']:
