...
class DataTrainingArguments:
    ...
    generate_synthetic_data: Optional[bool] = field(
        default=True,
        metadata={
            "help": (
                "Option to generate a synthetic dataset. Default is true."
            )
        },
    )
...
def main():
    ...
    for gen_num in tqdm(range(data_args.num_generations)):
        ...
        print(f"Generation {gen_num+1}/{data_args.num_generations} done! ... {globals.emoji_dict[gen_num]} ")
